%% BEAMER THEME Felipe Maldonado Data61/ANU based on Flip 2012: 

%%%%%%       Compile.tex file for compiling
%% 
%%
%% Copyright 2016 by Felipe Maldonado 
...
\usetheme[
	...
	watermark=data61logo,	% png file for the watermark: datal61logo contains a network and both data61 and ANU logos
	]{FM}
...
\author[Felipe Maldonado | \textcolor{darkcharcoal}{Felipe.Maldonado@data61.csiro.au |}]{Felipe Maldonado} %%% footpage information NAME  | MAIL  
\title[Social signals in online markets]{Social signals in online markets} % TITLE OF PRESENTATION
