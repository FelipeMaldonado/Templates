...
\node at (current page.south west){
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \draw[style=master lines](8in,0.19in)--(8in,11.41in); %vertical right border line
      ...
      \foreach \z in {0.716, 1.432,...,17.18}
      \draw[densely dotted](1.2in+\z cm,1in) -- (1.2in+\z cm, 10.5in);
...
\node at (current page.south west){
    ...
    \draw[style=master lines](8in,0.19in)--(8in,11.41in); %vertical right border line
      ...
      \draw[densely dotted](0.479,1in+\y cm) -- (7in, 1in+\y cm);
          \foreach \z in {0,0.717, 1.434,...,17.208}
      \draw[densely dotted](0.2in+\z cm,1in) -- (0.2in+\z cm, 10.5in);
